...
const {addOrder,ordersForRentalOfficewithstatus,getOrdersStatisticsByWeekDay,getReportData,getOrderById,acceptorder,getOrders,endOrder,getBookedDays, getOrdersByRentalOffice,getAllUserOrders}=require("../controllers/rentalOfficeOrders");
