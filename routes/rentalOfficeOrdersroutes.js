...
const {addOrder,ordersForRentalOfficewithstatus,getOrdersForRentalOfficeByWeekDay,getOrderById,acceptorder,getOrders,getBookedDays, getOrdersByRentalOffice,isAvailable}=require("../controllers/rentalOfficeOrders");
