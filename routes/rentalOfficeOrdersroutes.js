...
const {addOrder,ordersForRentalOfficewithstatus,getOrdersStatisticsByWeekDay,getOrdersForProfile,getReportData,getOrderById,acceptorder,getOrders,endOrder,getBookedDays, getOrdersByRentalOffice}=require("../controllers/rentalOfficeOrders");
...
router.get("/profile-order",getOrdersForProfile);
