...
const {addWinchOrder,addTireOrder,getUserMakeOrderandRating,getOrdersbyServiceType,changeStatusForOrder,ordersAndProfit,reportForProvider,getOrdersByServiceProvider,getOrderById}=require("../controllers/serviceProviderOrders");
